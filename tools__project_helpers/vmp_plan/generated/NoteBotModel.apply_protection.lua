local manifest = {
  { id = "NBVmp_Model_HookIdentity", raw_symbol = "?NBVmp_Model_HookIdentity@?A0xa0271e0f@@YA?AVQString@@AEBUHookDef@1@@Z", address = 0x0000000180018B60, category = "mutation" },
  { id = "NBVmp_Model_HookAddress", raw_symbol = "?NBVmp_Model_HookAddress@?A0xa0271e0f@@YA_K_KAEBUHookDef@1@@Z", address = 0x00000001800188D0, category = "mutation" },
  { id = "NBVmp_Model_CallTargetFromRel32", raw_symbol = "?NBVmp_Model_CallTargetFromRel32@?A0xa0271e0f@@YA_K_KAEBVQByteArray@@@Z", address = 0x0000000180018890, category = "ultra" },
  { id = "NBVmp_Model_HookBytesCompatible", raw_symbol = "?NBVmp_Model_HookBytesCompatible@?A0xa0271e0f@@YA?AU?$pair@_NVQString@@@std@@_KAEBVQByteArray@@AEBUHookDef@1@0I@Z", address = 0x00000001800188F0, category = "ultra" },
  { id = "NBVmp_Model_NormalizeArmSize", raw_symbol = "?NBVmp_Model_NormalizeArmSize@?A0xa0271e0f@@YA?AVQString@@AEBV2@@Z", address = 0x000000018001A100, category = "mutation" },
  { id = "NBVmp_Model_MakeJmp5", raw_symbol = "?NBVmp_Model_MakeJmp5@?A0xa0271e0f@@YA?AVQByteArray@@_K0PEA_N@Z", address = 0x0000000180018DB0, category = "ultra" },
  { id = "NBVmp_Model_MakeBoolShellcode", raw_symbol = "?NBVmp_Model_MakeBoolShellcode@?A0xa0271e0f@@YA?AVQByteArray@@_K00H@Z", address = 0x0000000180018BA0, category = "ultra" },
  { id = "NBVmp_Model_MakeStringArgShellcode", raw_symbol = "?NBVmp_Model_MakeStringArgShellcode@?A0xa0271e0f@@YA?AVQByteArray@@_K000@Z", address = 0x0000000180019EC0, category = "ultra" },
  { id = "NBVmp_Model_MakeSkinDataShellcode", raw_symbol = "?NBVmp_Model_MakeSkinDataShellcode@?A0xa0271e0f@@YA?AVQByteArray@@_K000H@Z", address = 0x0000000180018E60, category = "ultra" },
  { id = "NBVmp_Model_RuntimeModeRequested", raw_symbol = "?NBVmp_Model_RuntimeModeRequested@?A0xa0271e0f@@YA_N_N0@Z", address = 0x000000018001A200, category = "ultra" },
  { id = "NBVmp_Model_ModelAssetsConfigured", raw_symbol = "?NBVmp_Model_ModelAssetsConfigured@?A0xa0271e0f@@YA_NAEBVQString@@0@Z", address = 0x000000018001A0E0, category = "virtualize" },
  { id = "NBVmp_Model_SkinDimensionsAllowed", raw_symbol = "?NBVmp_Model_SkinDimensionsAllowed@?A0xa0271e0f@@YA_NHH@Z", address = 0x000000018001A210, category = "mutation" },
  { id = "NBVmp_Model_UsablePayloadReady", raw_symbol = "?NBVmp_Model_UsablePayloadReady@?A0xa0271e0f@@YA_NHHAEBVQByteArray@@@Z", address = 0x000000018001A240, category = "ultra" },
}

local selection_applied = false
local run_log_path = [[C:\NB\tools__project_helpers\vmp_plan\generated\logs\NoteBotModel.vmprotect_last_run.log]]
local run_log_first_line = true

local function log(message)
  local line = "[NoteBotModel VMP] " .. tostring(message)
