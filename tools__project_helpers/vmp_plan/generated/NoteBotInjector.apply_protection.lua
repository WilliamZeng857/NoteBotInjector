local manifest = {
  { id = "NBVmp_Injector_NormalizeLicenseKeyForIdentity", raw_symbol = "?NBVmp_Injector_NormalizeLicenseKeyForIdentity@@YA?AVQString@@AEBV1@@Z", address = 0x000000014005FCB0, category = "mutation" },
  { id = "NBVmp_Injector_MakeLocalKeyId", raw_symbol = "?NBVmp_Injector_MakeLocalKeyId@@YA?AVQString@@AEBV1@@Z", address = 0x000000014005F970, category = "virtualize" },
  { id = "NBVmp_Injector_ParseRemoteModelAsset", raw_symbol = "?NBVmp_Injector_ParseRemoteModelAsset@@YA_NAEBVQJsonObject@@PEAURemoteModelAsset@@@Z", address = 0x000000014005FDE0, category = "virtualize" },
  { id = "NBVmp_Injector_ParseRemoteModelEntry", raw_symbol = "?NBVmp_Injector_ParseRemoteModelEntry@@YA_NAEBVQJsonObject@@PEAURemoteModelEntry@@@Z", address = 0x0000000140060220, category = "virtualize" },
  { id = "NBVmp_Injector_HashBytesHex", raw_symbol = "?NBVmp_Injector_HashBytesHex@?A0x2ebb9e43@@YA?AVQString@@AEBVQByteArray@@W4Algorithm@QCryptographicHash@@@Z", address = 0x000000014007F7A0, category = "virtualize" },
  { id = "NBVmp_Injector_IsIpLiteralHost", raw_symbol = "?NBVmp_Injector_IsIpLiteralHost@?A0x2ebb9e43@@YA_NAEBVQString@@@Z", address = 0x000000014007F8B0, category = "mutation" },
  { id = "NBVmp_Injector_SignatureToHex", raw_symbol = "?NBVmp_Injector_SignatureToHex@?A0x2ebb9e43@@YA?AVQString@@AEBV?$array@E$0BAA@@std@@@Z", address = 0x000000014007FB70, category = "mutation" },
  { id = "NBVmp_Injector_CanonicalJsonString", raw_symbol = "?NBVmp_Injector_CanonicalJsonString@?A0x2ebb9e43@@YA?AVQString@@AEBV?$QList@U?$pair@VQString@@V1@@std@@@@AEBV?$QList@U?$pair@VQString@@_J@std@@@@@Z", address = 0x000000014007F320, category = "virtualize" },
  { id = "NBVmp_Injector_SafeArtifactFileName", raw_symbol = "?NBVmp_Injector_SafeArtifactFileName@?A0x2ebb9e43@@YA?AVQString@@AEBV2@@Z", address = 0x000000014007F960, category = "mutation" },
  { id = "NBVmp_Injector_AuthAbiMatches", raw_symbol = "?NBVmp_Injector_AuthAbiMatches@@YA_NHH@Z", address = 0x000000014005F950, category = "ultra" },
  { id = "NBVmp_Injector_ModelAbiMatches", raw_symbol = "?NBVmp_Injector_ModelAbiMatches@@YA_NHH@Z", address = 0x000000014005FC90, category = "ultra" },
  { id = "NBVmp_Injector_ProtectedLicenseEnvelopeReady", raw_symbol = "?NBVmp_Injector_ProtectedLicenseEnvelopeReady@?A0x2ebb9e43@@YA_NAEBVQByteArray@@@Z", address = 0x000000014007F930, category = "ultra" },
  { id = "NBVmp_Injector_ManifestIdentityReady", raw_symbol = "?NBVmp_Injector_ManifestIdentityReady@?A0x2ebb9e43@@YA_NAEBVQString@@00H0AEBVQByteArray@@@Z", address = 0x000000014007F8F0, category = "ultra" },
  { id = "NBVmp_Injector_SignManifestPayload", raw_symbol = "?NBVmp_Injector_SignManifestPayload@?A0x2ebb9e43@@YA_NAEBVQByteArray@@0AEAV?$array@E$0BAA@@std@@@Z", address = 0x000000014007F9E0, category = "ultra" },
}

local selection_applied = false
local run_log_path = [[C:\NB\tools__project_helpers\vmp_plan\generated\logs\NoteBotInjector.vmprotect_last_run.log]]
local run_log_first_line = true

local function log(message)
  local line = "[NoteBotInjector VMP] " .. tostring(message)
